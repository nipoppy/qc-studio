...
def load_svg_data(dataset_dir, path_dict: dict, max_montage_rows=None, max_montage_cols=None) -> Optional[dict]:
    ...
    for i, svg_path in enumerate(svg_paths_value):
        ...
        if file_ext == ".svg":
            ...
            try:
                ...
                image_data_dict[filename] = {"type": "svg", "content": svg_content}
            ...
            try:
                ...
                image_data_dict[filename] = {"type": raster_type, "content": pil_img}
                images_for_montage.append(pil_img)
    ...
    if len(images_for_montage) > 1:
        try:
            ...
            montage_img = create_grid_montage(images_for_montage, max_rows=max_montage_rows, max_cols=max_montage_cols)
